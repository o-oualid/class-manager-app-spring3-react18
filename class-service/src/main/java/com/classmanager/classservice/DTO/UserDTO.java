...
public record UserDTO (
        ...
        public UserDTO(String firstName, String lastName, String handle, String email, UserRole role, String backgroundPicture) {
                this(firstName, lastName, handle, email, role, null, backgroundPicture);
        }
}
